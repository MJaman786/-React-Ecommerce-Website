...
const SearchBar = ({userSearch, filterProductFunction}) => {
    ...
    return (
        <header style={headerStyle} >
            ...
            {/* SEARCH INPUT */}
            <div style={{ display: "flex", justifyContent: "center", margin: "40px 10px"}} >
                <input
                    value={userSearch}
                    onChange={(e) => filterProductFunction(e.target.value)}
                    onFocus={handleFocus}
                    onBlur={handleBlur}
                    type="text"
